...
export default function ShareView() {
    ...
    useEffect(() => {
        if (currentView === 'share') {
            ...
            setGeneratedLink(`wishcraft.app/w/${code}`)
            setCopied(false)
            // Stagger entrance
            ...
            <nav className="share-nav">
                <div className="share-nav-inner">
                    <div className="share-nav-brand">
                        <div className="share-nav-logo">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M4 6h16a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2zm0 2v1h16V8H4zm16 3H4v5h16v-5z" opacity=".2"/>
                                <path d="M21.707 11.293l-8-8A1 1 0 0 0 12 4v3.586L4.707 3.293a1 1 0 0 0-1.414 1.414l8 8A1 1 0 0 0 13 14v-3.586l7.293 7.293a1 1 0 0 0 1.414-1.414z"/>
                            </svg>
                        </div>
                        <span className="share-nav-title">WishCraft</span>
                    </div>
                    <div className="share-nav-links">
                        <button onClick={() => setCurrentView('editor')} className="share-nav-link">Editor</button>
                        <button className="share-nav-link">My Wishes</button>
                        <button className="share-nav-link">Profile</button>
                        <button onClick={handleCreateNew} className="share-nav-cta">Create New</button>
                    </div>
                </div>
            </nav>
